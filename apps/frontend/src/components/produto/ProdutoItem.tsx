...
export default function ProdutoItem(props: ProdutoItemProps) {
    ...
    return (
        <Link
            ...
            className="flex flex-col bg-violet-dark border border-white/20 rounded-xl relative max-w-[350px]">
            ...
            <div className="h-48 w-full relative">
                <Image src={produto.imagem} alt='Imagem do produto' className="object-contain" layout="fill" />
            </div>
